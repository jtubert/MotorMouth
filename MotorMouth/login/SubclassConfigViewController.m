...
@synthesize welcomeLabel, profilePhoto;
...
- (void) loadFacebookData{
    ...
    PF_FBRequest* r =[fb requestWithGraphPath:requestPath andDelegate:self];
}
...
- (void)request:(PF_FBRequest *)request didLoad:(id)result{
    ...
    [profilePhoto setImage:[UIImage imageWithData:[NSData dataWithContentsOfURL:pictureURL]]];
}
